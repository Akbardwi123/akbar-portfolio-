...
export const projects = [
  ...
  {
    id: 2,
    title: 'Mocknest (Mock API Generator)',
    date: { id: 'April 2026', en: 'April 2026' },
    featured: false,
    github: 'https://github.com/Akbardwi123/mock-api-generator',
    description: {
      id: 'Developer tool berbasis Monorepo SaaS (Fullstack TypeScript) untuk membuat mock API endpoint secara instan dan mandiri, didukung oleh Next.js 16, Express.js, dan Prisma PostgreSQL.',
      en: 'A Monorepo SaaS developer tool (Fullstack TypeScript) enabling instant, independent mock API generation, powered by Next.js 16, Express.js, and Prisma PostgreSQL.',
    },
    highlights: {
      id: [
        'Mengonfigurasi arsitektur Monorepo menggunakan npm workspaces & Concurrently untuk pengembangan frontend dan backend yang seamless.',
        'Mengimplementasikan sistem otentikasi Single Sign-On (SSO) terenkripsi di level frontend dan backend menggunakan Clerk SDK.',
        'Merancang skema relasional database PostgreSQL teroptimasi menggunakan Prisma ORM untuk mengelola workspace, mock endpoints, dan request logs.',
        'Mendukung kustomisasi API penuh dengan HTTP methods lengkap (GET, POST, PUT, DELETE), custom response status, JSON body, dan response delay.',
      ],
      en: [
        'Configured Monorepo workspace architecture with npm workspaces and Concurrently for a seamless development experience.',
        'Implemented secure Single Sign-On (SSO) authentication across both frontend and backend using Clerk SDK.',
        'Designed optimized PostgreSQL database schemas utilizing Prisma ORM to manage workspaces, mock endpoints, and requests logs.',
        'Supported fully customizable mocks with standard HTTP methods, custom status codes, dynamic JSON bodies, and configurable response delays.',
      ],
    },
    tech: ['Next.js 16', 'Express.js', 'TypeScript', 'Prisma ORM', 'PostgreSQL', 'Clerk Auth', 'Tailwind CSS v4', 'Monorepo'],
    icon: '⚡',
  },
  {
    id: 3,
    title: 'Env Secrets Manager (ESM)',
    date: { id: 'Mei 2026', en: 'May 2026' },
    featured: false,
    github: 'https://github.com/Akbardwi123/env-secrets-manager',
    description: {
      id: 'Aplikasi manajemen rahasia (secrets/env variables manager) open-source modern berbasis Monorepo (Bun Workspaces) untuk menyimpan, mengelola, dan mendistribusikan environment variables secara aman menggunakan arsitektur Envelope Encryption AES-256-GCM.',
      en: 'A modern open-source secrets/env variables manager powered by a Monorepo architecture (Bun Workspaces) to securely store, manage, and distribute environment variables using AES-256-GCM Envelope Encryption.',
    },
    highlights: {
      id: [
        'Mengembangkan sistem keamanan tingkat tinggi menggunakan arsitektur Envelope Encryption (AES-256-GCM) dengan Master Encryption Key (MEK) dan Data Encryption Key (DEK).',
        'Membangun arsitektur Monorepo menggunakan Bun Workspaces untuk mengintegrasikan Backend REST API (Hono & PostgreSQL), Frontend Dashboard (Next.js 16), dan CLI Tool.',
        'Mengembangkan CLI Tool developer esm menggunakan Commander.js untuk mengambil, mengunggah, dan menginjeksi secrets secara langsung ke memori proses (esm run).',
        'Mengintegrasikan autentikasi Clerk, webhook Svix untuk sinkronisasi data user, serta Drizzle ORM untuk manajemen database yang aman dan type-safe.',
      ],
      en: [
        'Developed a high-security encryption system utilizing Envelope Encryption (AES-256-GCM) with Master Encryption Key (MEK) and Data Encryption Key (DEK).',
        'Built a robust Monorepo architecture using Bun Workspaces to seamlessly integrate Backend REST API (Hono & PostgreSQL), Frontend Dashboard (Next.js 16), and developer CLI.',
        'Developed esm CLI developer tool using Commander.js to pull, push, and inject secrets directly into application process memory (esm run).',
        'Integrated Clerk authentication, Svix webhooks for user data synchronization, and Drizzle ORM for type-safe database management.',
      ],
    },
    tech: ['Next.js 16', 'Hono', 'TypeScript', 'Drizzle ORM', 'PostgreSQL', 'AES-256-GCM', 'Commander.js', 'Clerk Auth', 'Bun Workspaces', 'Tailwind CSS v4'],
    icon: '🛡️',
  },
];
  ...
  categories: [
    {
      ...
      icon: '⚙️',
      color: '#6366f1',
      items: ['Laravel (PHP)', 'Node.js', 'Express.js', 'Hono', 'RESTful API'],
    },
    {
      name: { id: 'Frontend', en: 'Frontend' },
      icon: '🎨',
      color: '#8b5cf6',
      items: ['HTML5', 'CSS3', 'JavaScript', 'Next.js', 'Tailwind CSS v4', 'Bootstrap', 'Blade Template'],
    },
    {
      name: { id: 'Database & Tools', en: 'Database & Tools' },
      icon: '🗄️',
      color: '#a78bfa',
      items: ['PostgreSQL', 'MySQL', 'Prisma', 'Drizzle ORM', 'Git', 'GitHub', 'Bun Workspaces', 'Postman', 'Laragon'],
    },
    {
